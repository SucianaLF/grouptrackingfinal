...
//                    Toast.makeText(Main4Activity.this, "You must enter a task first", Toast.LENGTH_LONG).show();
//                    return;
//                }
//                if(enteredTask.length() < 6){
//                    Toast.makeText(Main4Activity.this, "Task count must be more than 6", Toast.LENGTH_LONG).show();
//                    return;
//                }
...
//            recyclerViewAdapter = new RecyclerViewAdapter(Main4Activity.this, allTask);
